...
**This project will be opened to the public soon.**
...
- **broker-core** - TypeScript core library containing credential minting logic
- **broker-server** - NestJS HTTP server exposing the broker API
- **cli** - Go CLI client for interacting with the broker
- **sandbox** - Docker development environment with Keycloak and MinIO
